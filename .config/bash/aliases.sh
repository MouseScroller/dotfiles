...
alias mp4-download='youtube-dl --restrict-filenames --no-call-home '
alias mp3-download='youtube-dl --restrict-filenames --no-call-home --audio-quality 0 --extract-audio --audio-format mp3 '
...
HISTIGNORE="vlc *:mp4-download *:ll:e:mp3-download *:rm *"
